...
void soundtest_draw(Gfx *gfxList_ptr, u32 gfxListSize, u32 ucode, u32 flag)
{
    Gfx *dlHead = gfxList_ptr + (gfxListSize / sizeof(Gfx));
    dlHead -= 2; // Overwrite the fullsync and enddl
    // char text[9];
    // text[0] = 'S';
    // text[1] = 'o';
    // text[2] = 'u';
    ...
    // drawSmallStringCol(&dlHead, 80, 30, "Custom text", 0, 0, 0);
    gDPFullSync(dlHead++);
